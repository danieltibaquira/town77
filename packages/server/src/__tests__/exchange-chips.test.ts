...
describe('exchange_chips', () => {
  ...
  it('emits game_over when exchange empties the bag and no valid moves remain', async () => {
    ...
    s.players[turnIdx]!.hand = [...exchangeChips]
    ...
    activeClient.emit('exchange_chips', { chips: exchangeChips })
